...
Script to log into a controller and delete all sensors
"""
...
def main():
   ...
   """
   Get list of sensors on the system
   """
   s, headers = getToken(s)
   try:
   ...
   for obj in response.json():
      ...
      try:
         ...
         response = s.delete(sensors_url + "/" + obj["uuid"], headers=headers, data=data)
      except:
