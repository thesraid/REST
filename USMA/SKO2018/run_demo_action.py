...
def main():
   ...
   Get Sensor UUID
   """
   print colored ("INFO: Searching for sensor", "blue")
   s, headers = getToken(s)
   try:
   ...
   if sensor_uuid: 
      print colored ("INFO: Found sensor", "blue")
   ...
   for action in app_actions:
      print colored ("INFO: Running Demo App Action - " + action, "blue")
   ...
   print colored ("INFO: Script completed", "blue")
